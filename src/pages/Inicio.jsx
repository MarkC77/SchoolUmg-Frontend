...
import { getAlumnosPorAsignatura, getDistribucionCalificaciones } from "../services/data";
  ...
  useEffect(() => {
    ...
    getAlumnosPorAsignatura()
        .then((data) => {
            ...
            // Generar colores dinamicos si hay más asignaturas
            const colores = [
                "#3498db", "#2ecc71", "#e74c3c", "#f1c40f", "#9b59b6",
                "#1abc9c", "#34495e", "#e67e22", "#8e44ad", "#7f8c8d",
            ].slice(0, data.length);
        ...
        .catch((err) => console.error("Error cargando alumnos por asignatura:", err));
    ...
    getDistribucionCalificaciones()
        ...
        .catch((err) => console.error("Error cargando distribucion de calificaciones:", err));
}, []);
return (
